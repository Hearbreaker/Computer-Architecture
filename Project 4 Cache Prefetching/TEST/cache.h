...
#define PREFETCH_DEGREE 16    /* maximum number of prefteches */
#define INDEX_TABLE_SIZE 256   /* size of index table */
#define INDEX_OFFSET 16   /* size of index table */
#define MAX_GHB_SIZE 256  /* Number of entries in GHB */
...
struct ghb_entry{
  ...
  struct index_table_entry *linked_ite;
};
